...
import static src.product.Condition.MAX;
import static src.product.Condition.MIN;
...
public abstract class IOManager {
    ...
    protected src.product.eyes.Color eyeColor;
    protected src.product.hair.Color hairColor;
    ...
    src.product.eyes.Color checkEyesColor(String data) throws InvalidArgument {
        switch (data) {
            case "BLUE":
                return src.product.eyes.Color.BLUE;
            case "ORANGE":
                return src.product.eyes.Color.ORANGE;
            case "GREEN":
                return src.product.eyes.Color.GREEN;
            case "RED":
                return src.product.eyes.Color.RED;
            default:
                throw new InvalidArgument("Could not find this eye color");
        }
    }

    src.product.hair.Color checkHairColor(String data) throws InvalidArgument {
        switch (data) {
            case "BLACK":
                return src.product.hair.Color.BLACK;
            case "WHITE":
                return src.product.hair.Color.WHITE;
            case "YELLOW":
                return src.product.hair.Color.YELLOW;
            case "ORANGE":
                return src.product.hair.Color.ORANGE;
            case "":
                return null;
            default:
