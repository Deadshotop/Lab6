...
import static src.product.Condition.FIRST_ID;
/**
...
//    }
    ...
    public Product getProduct() {
        Product product = new Product(FIRST_ID++, getProductName(), new Coordinates(getX(), getY()), LocalDateTime.now(), getPrice(), getManufactureCost(), getUnitOfMeasure(), getOwner());
    ...
    private String getProductName() {
        String arg;
        while (true) {
            stringManager.multiLine("Enter src.product name");
            try {
