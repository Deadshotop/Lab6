...
public class Person {
    ...
    private src.product.eyes.Color eyeColor; //Поле не может быть null
    private src.product.hair.Color hairColor; //Поле может быть null
    ...
    public Person(String name, ZonedDateTime birthday, Color eyeColor, src.product.hair.Color hairColor, Country nationality, Location location) {
        this.name = name;
